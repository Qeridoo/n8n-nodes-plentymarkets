...
## Repository map
- `credentials/` — explain what lives here and when agents should edit it.
- `gulpfile.js/` — explain what lives here and when agents should edit it.
- `nodes/` — explain what lives here and when agents should edit it.
